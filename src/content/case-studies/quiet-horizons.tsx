...
export const quietHorizons: ClientCaseStudyContent = {
  ...
  architecture: {
    ...
    walkthrough: (
      <>
        ...
        <p className="mt-3">
          The trade-off is honest: encrypted columns aren&rsquo;t searchable. We pay that cost
        ...
        <p className="mt-6">
          ...
          append an audit-log row for the action. SQL-level immutability rather than policy-level
        ...
        <p className="mt-3">
          ...
          covered service vendor is the same vendor. The boring version is the safe version.
        </p>
      </>
    ),
  },
  ...
  engagementNote: (
    <p>
      ...
      otherwise-regulated practice and want an ambient AI workflow that respects the compliance
      surface as a first-class constraint rather than a retrofit, a 30-minute architecture call
